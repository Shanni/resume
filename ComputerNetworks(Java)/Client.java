...
public class Client{
      ...
      if (state == READY) 
	{
	  ...
	  if (parse_server_response() != 200)
	  ...
	  else 
	    {
	      ...
	      state=PLAYING;
	       System.out.println("New RTSP state: PLAYING in ready...");
      ...
      if (state == PLAYING) 
	{
	 ...
	 if (parse_server_response() != 200)
	  ...
	  else 
	    {
	      //change RTSP state and print out new state
	     state=READY;
	      System.out.println("New RTSP state:READY in playing: READY in pause");
  ...
  class tearButtonListener implements ActionListener {
	...
	{     
	  //change RTSP state and print out new state
	  state=INIT;
	  System.out.println("New RTSP state: INIT in tearButton");
